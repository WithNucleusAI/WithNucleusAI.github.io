        ...
        <div className="w-full flex flex-col items-center px-6 sm:px-8">
            ...
            <div
                className={`mx-auto w-full text-center ${
                    isNucleus
                        ? "display-type text-[clamp(56px,15vw,224px)] text-white"
                        : "max-w-md text-[16px] sm:text-[17px] text-white/70 leading-[1.7]"
                }`}
            >
                ...
                {!showCaption && (
                    <span
                        ...
                        className={`inline-block align-middle ml-[2px] ${
                            isNucleus
                                ? "w-[4px] h-[0.75em] bg-white/30"
                                : "w-[6px] h-[16px] sm:h-[18px] bg-white/25"
                        }`}
                    />
                )}
            </div>
            ...
            {showCaption && (
                <div className="mt-5 sm:mt-8 flex flex-col items-center">
                    <span
                        ...
                        className="eyebrow text-surface-50"
                    >
