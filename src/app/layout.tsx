        ...
        <header className="relative w-full px-4 py-4 sm:px-8 sm:py-6 flex justify-between items-center box-border z-50 bg-transparent pointer-events-none">
          <div className="logo-container pointer-events-auto">
            <Link href="/" className="flex items-center gap-2 sm:gap-3 no-underline text-inherit font-bold text-lg sm:text-xl transition-opacity duration-200 hover:opacity-80">
              <Image src="/logo.png" alt="Nucleus AI Logo" width={40} height={40} className="w-8 h-8 sm:w-10 sm:h-10" />
          ...
          <nav className="flex gap-4 sm:gap-8 pointer-events-auto">
            <Link href="/" className="no-underline text-black/60 font-medium text-sm sm:text-base transition-colors duration-200 hover:text-black">Home</Link>
            <Link href="/blog" className="no-underline text-black/60 font-medium text-sm sm:text-base transition-colors duration-200 hover:text-black">Blogs</Link>
          </nav>
        </header>
        <main className="flex-1 flex flex-col w-full relative z-10 pointer-events-none">{children}</main>
