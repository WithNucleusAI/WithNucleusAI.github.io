...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${plexMono.variable} ${inconsolata.variable} ${playfair.variable} text-[rgb(10,10,10)] dark:text-gray-100 bg-white dark:bg-[#030308] flex flex-col items-center text-center min-h-screen m-0 p-0 overflow-x-hidden`}>
        <ThemeProvider
          attribute="class"
          defaultTheme="dark"
          forcedTheme="dark"
